...
import "OpenZeppelin/openzeppelin-contracts@3.3.0/contracts/token/ERC1155/IERC1155Receiver.sol";
...
contract LsLMSR is IERC1155Receiver, Ownable, ChainlinkClient{
  ...
  constructor(
    ...
    token = _token;
    oracle = 0x97376EC350093B21216aF57DFfC352846d21F276; // oracle address
    jobId = "d646c36fb792410f81503aaec57030ee"; //job id
  ...
  function requestMatchOutcome() public {
    Chainlink.Request memory req = buildChainlinkRequest(jobId, address(this), this.fulfill.selector);
    req.add("match_id", oracleId);
    sendChainlinkRequestTo(oracle, req, fee);
  }

  /**
   * Receive the response in the form of uint
   */
  function fulfill(bytes32 _requestId, uint _result) public recordChainlinkFulfillment(_requestId) {
    require(_result<4,'Invalid result');
    uint[] memory payout = new uint[](3);
    payout[_result-1] = 1;
    CT.reportPayouts(questionId, payout);
    outcome = _result;
  }
